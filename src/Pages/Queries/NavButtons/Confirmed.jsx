...
import { Button, FormControl, FormGroup, Drawer, MenuItem } from "@mui/material";
...
function AddQueryForm({ closeDrawer }) {
  return (
   ...
   <FormGroup  FormGroup row sx={{ gap: '0.5rem',  flexWrap: 'nowrap', '& > *': { flex: 1 }, color: "red" }}>
        ...
        <Link to="/queries/confirmed/detail">
...
function goToQueries() {
  ...
  <div className="font-[700] flex-shrink-0 mr-3">Confirmed</div>
