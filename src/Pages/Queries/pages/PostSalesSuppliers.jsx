...
const PostSalesSuppliers = () => {
  ...
  const obj = [
    {
      ...
      tableValue1: <div>Abad Hotels <br />CN: 1234</div>,
  ...
  return (
    ...
    <div className="p-3 bg-[#f2f4f8] h-auto flex flex-col gap-3">
      {obj.map((item)=>{
        return <PostSalesCard head={item.head} smallHead={item.smallHead} tValue1={item.tableValue1} tValue2={item.tableValue2} tValue3={item.tableValue3} tValue4={item.tableValue4} tValue5={item.tableValue5} tValue6={item.tableValue6} tValue7={item.tableValue7} tValue8={item.tableValue8}/>
      })}
